        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-2/3 p-6">
            ...
            <div className="bg-gray-800 rounded-lg p-5 mb-6 border border-gray-700">
              ...
              <button 
                onClick={nextAdvice}
                className="flex items-center justify-center gap-2 px-4 py-2 bg-orange-200 hover:bg-red-800 text-black hover:text-white font-semibold rounded-xl shadow-md transition duration-300 ease-in-out transform hover:scale-105  w-full"
              >
