                ...
                <div className="relative z-10 h-full flex flex-col">
                  ...
                  >
                    <img 
                      src={item.image} 
                      alt={item.title}
                      className="w-full sm:h-64 h-48 object-fill"
                    />
                    {/* Image Overlay */}
                    <motion.div 
                  ...
                  <div className="flex-1 space-y-4">
                    ...
                    >
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-green-300 text-sm font-medium">Bonne valeur:</span>
                        <span className="text-gray-300 text-sm">{item.goodValue}</span>
                      </div>
                      
                      <div className="flex items-center space-x-2">
                        <span className="text-red-400 text-sm">❌</span>
                        <span className="text-red-300 text-sm font-medium">Mauvaise valeur:</span>
